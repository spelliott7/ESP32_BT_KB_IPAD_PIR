...
//UPDATE PIN FOR TABLET AT BOTTOM OF CODE

// Wifi: SSID and password
const PROGMEM char* WIFI_SSID = "WIFI NAME";
...
// MQTT: topic
const PROGMEM char* MQTT_MOTION_STATUS_TOPIC = "ipad/motion"; //SET topic paramaters here

const PROGMEM char* MOTION_ON = "ON";
const PROGMEM char* MOTION_OFF = "OFF";


const PROGMEM uint8_t PIR_PIN = 27; //ESP32 PIR pin CHANGE AS NEEDED
...
void loop() {
  ...
  // read the PIR sensor and send code. Replace 9s
  ...
  if (m_pir_value == HIGH) {
    if (m_pir_state == LOW) {
      ...
      bleKeyboard.write(32);
      delay(3500);
      bleKeyboard.print("9999"); // CHANGE this pin for your iPad
